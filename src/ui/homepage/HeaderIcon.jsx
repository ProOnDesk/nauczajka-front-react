...
function HeaderIcon() {
	return (
		<>
			<div className="absolute top-[310px] right-6  flex gap-2 text-mainPurple min-[420px]:text-xl min-[535px]:text-2xl min-[535px]:right-12 min-[535px]:top-[320px] sm:top-[380px] sm:text-2xl sm:right-[120px] md:right-[100px] md:top-[170px] lg:right-[130px] lg:text-4xl	">
				{" "}
