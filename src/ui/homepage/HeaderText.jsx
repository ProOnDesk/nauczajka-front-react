function HeaderText() {
	return (
		<div className="flex flex-col w-full z-10 ">
			...
			<p className="p-6  text-sm w-full text-left leading-7 backdrop:text-mainBlue min-[-375px]:p-10 min-[375px]:w-w-11/12	 min-[481px]:w-5/6	min-[481px]:text-base min-[481px]:leading-8 sm:text-lg sm:leading-9 sm:p-12 md:text-base md:w-2/3 md:py-8 md:leading-7 lg:text-lg lg:leading-9 xl:text-xl xl:leading-10">
