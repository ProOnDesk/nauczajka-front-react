			...
			<div className="flex justify-center items-center flex-col h-full w-full mt-20 bg-mainPurple min-[375px]:mt-36 md:mt-44 md:rounded-tl-lg min-[535px]:mt-52">
				<div className="flex flex-col md:flex-row justify-center items-center">
					<div className="md:w-5/12">
						...
						<p className="p-6 mt-5  text-center text-xs leading-loose text-white min-[375px]:text-sm min-[375px]:p-7 md:text-ms md:text-left md:px-5 md:py-0 md:leading-relaxed md:mb-12">
