...
function HeaderFooter() {
	return (
		<>
			<div className="flex justify-center items-center flex-col h-[800px] w-full mt-20 shadow-xl  min-[375px]:mt-36 min-[523px]:mt-40 min-[531px]:mt-52 min-[535px]:h-[600px] min-[570px]:mt-60  sm:mt-36 sm:h-[650px] md:mt-24 md:h-[420px] md:rounded-xl min-[910px]:mt-36 min-[1070px]:mt-56 bg-mainPurple  ">
