...
function OfferText() {
	return (
		<div className="flex flex-col justify-center items-center md960:mr-auto md960:my-6 md960:mx-8">
			<div className="md960:w-[550px]">
				...
				<div className="p-6 text-sm text-center leading-relaxed text-mainBlue md960:py-2">
					...
					<div className="flex flex-row justify-center items-center mt-10 text-4xl gap-10 text-mainPurple min-[535px]:text-5xl min-[535px]:py-5 min-[535px]:gap-14 md960:text-3xl md960:my-2 md960:gap-10">
						<PiCalculatorThin />
						<PiTranslateThin />
						<PiPencilLineThin />
					</div>
					<p className=" mt-10 w-full text-center min-[440px]:text-base min-[535px]:text-lg min-[535px]:px-5 min-[600px]:px-8  min-[600px]:leading-loose sm:px-8  min-[680px]:px-11 min-[840px]:px-20 md:px-20 md:text-xl md:leading-loose md960:text-xs md960:leading-relaxed md960:px-28 md960:mt-4">
